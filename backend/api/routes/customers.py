...
async def get_customers(
    ...
    try:
        with get_db_context() as db:
            ...
            customers = query.order_by(Customer.churn_probability.desc()).offset(offset).limit(page_size).all()
        ...
        return {
            ...
            "page_size": page_size,
            "total_pages": 250,
            "customers": [generate_mock_customer(f"C{1000000 + (page-1)*page_size + i}") for i in range(page_size)]
        }
